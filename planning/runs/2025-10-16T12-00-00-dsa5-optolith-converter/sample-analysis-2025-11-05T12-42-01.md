...
### Resolver Warnings
- armor: Eintrag "normale Kleidung oder nackt" konnte im Abschnitt armor nicht aufgelöst werden.

### Unresolved References
- **armor**: normale Kleidung oder nackt

### Exporter Warnings
- [Resolver] armor: Eintrag "normale Kleidung oder nackt" konnte im Abschnitt armor nicht aufgelöst werden.
- [Resolver] armor: unverarbeitet "normale Kleidung oder nackt"
...
### Resolver Warnings
- armor: BE (0) weicht vom Optolith-Wert (1) ab.

### Unresolved References
- None

### Exporter Warnings
- [Resolver] armor: BE (0) weicht vom Optolith-Wert (1) ab.
...
### Resolver Warnings
- armor: BE (1) weicht vom Optolith-Wert (3) ab.

### Unresolved References
- None

### Exporter Warnings
- [Resolver] armor: BE (1) weicht vom Optolith-Wert (3) ab.
...
### Resolver Warnings
- equipment: Eintrag "Immanschläger" konnte im Abschnitt equipment nicht aufgelöst werden.
- equipment: Ausrüstungseintrag "den er als Knüppel nutzt" wurde als "Knüppel" interpretiert (Teilbegriff "Knüppel").

### Unresolved References
- **equipment**: Immanschläger

### Exporter Warnings
- [Resolver] equipment: Eintrag "Immanschläger" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] equipment: Ausrüstungseintrag "den er als Knüppel nutzt" wurde als "Knüppel" interpretiert (Teilbegriff "Knüppel").
- [Resolver] equipment: unverarbeitet "Immanschläger"
...
- advantages: Eintrag "etwa Personlichkeitsschwächen (Eitelkeit, Neid)" konnte im Abschnitt advantages nicht aufgelöst werden.
- disadvantages: Eintrag "individuell" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- disadvantages: Eintrag "etwa Personlichkeitsschwächen (Eitelkeit, Neid)" konnte im Abschnitt disadvantages nicht aufgelöst werden.

### Unresolved References
- **advantages**: individuell, etwa Personlichkeitsschwächen (Eitelkeit, Neid)
- **disadvantages**: individuell, etwa Personlichkeitsschwächen (Eitelkeit, Neid)

### Exporter Warnings
- [Resolver] advantages: Eintrag "individuell" konnte im Abschnitt advantages nicht aufgelöst werden.
- [Resolver] advantages: Eintrag "etwa Personlichkeitsschwächen (Eitelkeit, Neid)" konnte im Abschnitt advantages nicht aufgelöst werden.
- [Resolver] disadvantages: Eintrag "individuell" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] disadvantages: Eintrag "etwa Personlichkeitsschwächen (Eitelkeit, Neid)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] advantages: unverarbeitet "individuell"
- [Resolver] advantages: unverarbeitet "etwa Personlichkeitsschwächen (Eitelkeit, Neid)"
- [Resolver] disadvantages: unverarbeitet "individuell"
- [Resolver] disadvantages: unverarbeitet "etwa Personlichkeitsschwächen (Eitelkeit, Neid)"

## Bewohner Frisovs

### Parser Warnings
- talents: Talent konnte nicht interpretiert werden: "ein Talent"
- talents: Talent konnte nicht interpretiert werden: "das er für seinen Beruf nutzt 10 (etwa Fischen & Angeln, Tierkunde, Fährtensuchen oder ein Handwerkstalent)"
...
### Exporter Warnings
- [Parser] talents: Talent konnte nicht interpretiert werden: "ein Talent"
- [Parser] talents: Talent konnte nicht interpretiert werden: "das er für seinen Beruf nutzt 10 (etwa Fischen & Angeln, Tierkunde, Fährtensuchen oder ein Handwerkstalent)"
...
### Resolver Warnings
- disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- specialAbilities: Eintrag "Tradition (Rondrageweihter)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- blessings: Eintrag "die Zwölf Segnungen" konnte im Abschnitt blessings nicht aufgelöst werden.
- equipment: Ausrüstungseintrag "Geweihter Rondrakamm Isgart" wurde als "Rondrakamm" interpretiert (Teilbegriff "Rondrakamm").

### Unresolved References
- **disadvantages**: Persönlichkeitsschwäche (Arroganz)
- **specialAbilities**: Tradition (Rondrageweihter)
- **blessings**: die Zwölf Segnungen

### Exporter Warnings
- [Resolver] disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Tradition (Rondrageweihter)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] blessings: Eintrag "die Zwölf Segnungen" konnte im Abschnitt blessings nicht aufgelöst werden.
...
- [Resolver] disadvantages: unverarbeitet "Persönlichkeitsschwäche (Arroganz)"
- [Resolver] specialAbilities: unverarbeitet "Tradition (Rondrageweihter)"
- [Resolver] blessings: unverarbeitet "die Zwölf Segnungen"
...
### Resolver Warnings
- specialAbilities: Eintrag "Tradition (Praiosgeweihte)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- blessings: Eintrag "Die zwölf Segnungen" konnte im Abschnitt blessings nicht aufgelöst werden.
...
### Exporter Warnings
- [Resolver] specialAbilities: Eintrag "Tradition (Praiosgeweihte)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] blessings: Eintrag "Die zwölf Segnungen" konnte im Abschnitt blessings nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Wintertaugliche Robe" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] specialAbilities: unverarbeitet "Tradition (Praiosgeweihte)"
- [Resolver] blessings: unverarbeitet "Die zwölf Segnungen"
...
### Resolver Warnings
- disadvantages: Eintrag "Persönlichkeitsschwäche (Vorurteile gegen Nichtzwölfgöttergläubige)" konnte im Abschnitt disadvantages nicht aufgelöst werden.

### Unresolved References
- **disadvantages**: Persönlichkeitsschwäche (Vorurteile gegen Nichtzwölfgöttergläubige)

### Exporter Warnings
- [Resolver] disadvantages: Eintrag "Persönlichkeitsschwäche (Vorurteile gegen Nichtzwölfgöttergläubige)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] disadvantages: unverarbeitet "Persönlichkeitsschwäche (Vorurteile gegen Nichtzwölfgöttergläubige)"

## Mrom

### Parser Warnings
- talents: Talent konnte nicht interpretiert werden: "Verbergen 8**"

### Resolver Warnings
- specialAbilities: Eintrag "Angriff verbessern" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Haltegriff (Waffenlos) Schildspalter (Yeti-Keule)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Wuchtschlag I-III (Waffenlos, Yeti-Keule)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.

### Unresolved References
- **specialAbilities**: Angriff verbessern, Haltegriff (Waffenlos) Schildspalter (Yeti-Keule), Wuchtschlag I-III (Waffenlos, Yeti-Keule)

### Exporter Warnings
- [Parser] talents: Talent konnte nicht interpretiert werden: "Verbergen 8**"
- [Resolver] specialAbilities: Eintrag "Angriff verbessern" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Haltegriff (Waffenlos) Schildspalter (Yeti-Keule)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Wuchtschlag I-III (Waffenlos, Yeti-Keule)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: unverarbeitet "Angriff verbessern"
- [Resolver] specialAbilities: unverarbeitet "Haltegriff (Waffenlos) Schildspalter (Yeti-Keule)"
- [Resolver] specialAbilities: unverarbeitet "Wuchtschlag I-III (Waffenlos, Yeti-Keule)"
...
### Resolver Warnings
- advantages: Eintrag "Immunität gegen Zorganpocken" konnte im Abschnitt advantages nicht aufgelöst werden.
- specialAbilities: Eintrag "Schnelladen (Wurfwaffen)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- equipment: Eintrag "Anaurak" konnte im Abschnitt equipment nicht aufgelöst werden.
- equipment: Ausrüstungseintrag "drei Speere" wurde als "Speer" interpretiert (Schlüsselwort "speer").
- equipment: Eintrag "vier Wurfkeulen" konnte im Abschnitt equipment nicht aufgelöst werden.

### Unresolved References
- **advantages**: Immunität gegen Zorganpocken
- **specialAbilities**: Schnelladen (Wurfwaffen)
- **equipment**: Anaurak, vier Wurfkeulen

### Exporter Warnings
- [Resolver] advantages: Eintrag "Immunität gegen Zorganpocken" konnte im Abschnitt advantages nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Schnelladen (Wurfwaffen)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Anaurak" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] equipment: Ausrüstungseintrag "drei Speere" wurde als "Speer" interpretiert (Schlüsselwort "speer").
- [Resolver] equipment: Eintrag "vier Wurfkeulen" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] advantages: unverarbeitet "Immunität gegen Zorganpocken"
- [Resolver] specialAbilities: unverarbeitet "Schnelladen (Wurfwaffen)"
- [Resolver] equipment: unverarbeitet "Anaurak"
- [Resolver] equipment: unverarbeitet "vier Wurfkeulen"
...
- disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz, Weltfremd)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
...
- spells: Eintrag "Analys" konnte im Abschnitt spells nicht aufgelöst werden.
- spells: Eintrag "Attributo (KK)" konnte im Abschnitt spells nicht aufgelöst werden.
- spells: Eintrag "Odem" konnte im Abschnitt spells nicht aufgelöst werden.

### Unresolved References
- **disadvantages**: Metallempfindlich, Persönlichkeitsschwäche (Arroganz, Weltfremd)
- **specialAbilities**: Tradition (Nachtalben)
- **spells**: Schlangenhände, Trocken, Analys, Attributo (KK), Odem
...
- [Resolver] disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz, Weltfremd)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
...
- [Resolver] spells: Eintrag "Analys" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Attributo (KK)" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Odem" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] disadvantages: unverarbeitet "Metallempfindlich"
- [Resolver] disadvantages: unverarbeitet "Persönlichkeitsschwäche (Arroganz, Weltfremd)"
...
- [Resolver] spells: unverarbeitet "Analys"
- [Resolver] spells: unverarbeitet "Attributo (KK)"
- [Resolver] spells: unverarbeitet "Odem"
...
### Resolver Warnings
- disadvantages: Eintrag "Metallempfindlich" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Tradition (Nachtalben)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- spells: Eintrag "Feuerfinger" konnte im Abschnitt spells nicht aufgelöst werden.
- rituals: Eintrag "Zauberklinge" konnte im Abschnitt rituals nicht aufgelöst werden.
- equipment: Ausrüstungseintrag "zwei Shakagra-Schwerter" wurde als "Langschwert" interpretiert (Schlüsselwort "schwert").
...
- **specialAbilities**: Beidhändiger Kampf I-II, Finte I-II, Tradition (Nachtalben)
- **spells**: Feuerfinger
- **rituals**: Zauberklinge

### Exporter Warnings
- [Parser] spells: Wert für spells konnte nicht ermittelt werden: "Feuerfinger"
- [Resolver] disadvantages: Eintrag "Metallempfindlich" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Tradition (Nachtalben)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Feuerfinger" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] rituals: Eintrag "Zauberklinge" konnte im Abschnitt rituals nicht aufgelöst werden.
- [Resolver] equipment: Ausrüstungseintrag "zwei Shakagra-Schwerter" wurde als "Langschwert" interpretiert (Schlüsselwort "schwert").
...
- [Resolver] disadvantages: unverarbeitet "Metallempfindlich"
- [Resolver] specialAbilities: unverarbeitet "Beidhändiger Kampf I-II"
- [Resolver] specialAbilities: unverarbeitet "Finte I-II"
- [Resolver] specialAbilities: unverarbeitet "Tradition (Nachtalben)"
- [Resolver] spells: unverarbeitet "Feuerfinger"
- [Resolver] rituals: unverarbeitet "Zauberklinge"
...
- spells: Wert für spells konnte nicht ermittelt werden: "Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)"

### Resolver Warnings
- spells: Eintrag "Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)" konnte im Abschnitt spells nicht aufgelöst werden.

### Unresolved References
- **spells**: Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)

### Exporter Warnings
- [Parser] advantages: Abschnitt "advantages" nicht gefunden.
- [Parser] disadvantages: Abschnitt "disadvantages" nicht gefunden.
- [Parser] spells: Wert für spells konnte nicht ermittelt werden: "Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)"
- [Resolver] spells: Eintrag "Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] spells: unverarbeitet "Paralysis 18 (Die Opfer fliehen nicht, sondern erstarren vor Furcht.)"
...
### Resolver Warnings
- spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.
- equipment: Eintrag "Shakagra-Giftdolch" konnte im Abschnitt equipment nicht aufgelöst werden.

### Unresolved References
- **spells**: Eigne Ängste
- **equipment**: Shakagra-Giftdolch

### Exporter Warnings
- [Resolver] spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Shakagra-Giftdolch" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] spells: unverarbeitet "Eigne Ängste"
- [Resolver] equipment: unverarbeitet "Shakagra-Giftdolch"
...
### Resolver Warnings
- disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz, Neid)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
...
### Unresolved References
- **disadvantages**: Persönlichkeitsschwäche (Arroganz, Neid)
- **specialAbilities**: andere kann sie ob ihres Alters nicht mehr nutzen
- **languages**: Oloargh I

### Exporter Warnings
- [Resolver] disadvantages: Eintrag "Persönlichkeitsschwäche (Arroganz, Neid)" konnte im Abschnitt disadvantages nicht aufgelöst werden.
...
- [Resolver] disadvantages: unverarbeitet "Persönlichkeitsschwäche (Arroganz, Neid)"
...
### Resolver Warnings
- disadvantages: Eintrag "Arroganz" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Finte I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Kampfreflexe I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Verbessertes Ausweichen I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.
- equipment: Eintrag "Leichte Shakagra-Platte" konnte im Abschnitt equipment nicht aufgelöst werden.
- equipment: Eintrag "Shakagra-Krummsäbel (2)" konnte im Abschnitt equipment nicht aufgelöst werden.

### Unresolved References
- **disadvantages**: Arroganz
- **specialAbilities**: Beidhändiger Kampf I-II, Finte I-III, Kampfreflexe I-III, Verbessertes Ausweichen I-III
- **spells**: Eigne Ängste
- **equipment**: Leichte Shakagra-Platte, Shakagra-Krummsäbel (2)

### Exporter Warnings
- [Resolver] disadvantages: Eintrag "Arroganz" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Finte I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Kampfreflexe I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Verbessertes Ausweichen I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Leichte Shakagra-Platte" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Shakagra-Krummsäbel (2)" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] disadvantages: unverarbeitet "Arroganz"
- [Resolver] specialAbilities: unverarbeitet "Beidhändiger Kampf I-II"
- [Resolver] specialAbilities: unverarbeitet "Finte I-III"
- [Resolver] specialAbilities: unverarbeitet "Kampfreflexe I-III"
- [Resolver] specialAbilities: unverarbeitet "Verbessertes Ausweichen I-III"
- [Resolver] spells: unverarbeitet "Eigne Ängste"
- [Resolver] equipment: unverarbeitet "Leichte Shakagra-Platte"
- [Resolver] equipment: unverarbeitet "Shakagra-Krummsäbel (2)"
...
- specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- equipment: Eintrag "Leichte Shakagra-Platte" konnte im Abschnitt equipment nicht aufgelöst werden.
- equipment: Ausrüstungseintrag "Shakagra-Langschild" wurde als "Holzschild" interpretiert (Schlüsselwort "schild").
- equipment: Ausrüstungseintrag "Shakagra-Hammer" wurde als "Hammer" interpretiert (Teilbegriff "Hammer").

### Unresolved References
- **specialAbilities**: Finte I-II
- **equipment**: Leichte Shakagra-Platte

### Exporter Warnings
- [Resolver] specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] equipment: Eintrag "Leichte Shakagra-Platte" konnte im Abschnitt equipment nicht aufgelöst werden.
- [Resolver] equipment: Ausrüstungseintrag "Shakagra-Langschild" wurde als "Holzschild" interpretiert (Schlüsselwort "schild").
...
### Resolver Warnings
- disadvantages: Eintrag "Angst vor (… (Feuer, Luchsen))" konnte im Abschnitt disadvantages nicht aufgelöst werden.
...
- [Parser] talents: Talent konnte nicht interpretiert werden: "Selbstbeherrschung - (gelingt automatisch)"
- [Parser] talents: Talent konnte nicht interpretiert werden: "Willenskraft - (gelingt automatisch)"
- [Resolver] disadvantages: Eintrag "Angst vor (… (Feuer, Luchsen))" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] disadvantages: unverarbeitet "Angst vor (… (Feuer, Luchsen))"
...
### Resolver Warnings
- specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Mächtiger Schlag (Krallen, Schwanz)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.

### Unresolved References
- **specialAbilities**: Finte I-II, Mächtiger Schlag (Krallen, Schwanz)
- **spells**: Eigne Ängste
...
- [Parser] talents: Talent konnte nicht interpretiert werden: "Selbstbeherrschung - (gelingt automatisch)"
- [Resolver] specialAbilities: Eintrag "Finte I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Mächtiger Schlag (Krallen, Schwanz)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Eigne Ängste" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] specialAbilities: unverarbeitet "Finte I-II"
- [Resolver] specialAbilities: unverarbeitet "Mächtiger Schlag (Krallen, Schwanz)"
- [Resolver] spells: unverarbeitet "Eigne Ängste"
...
### Parser Warnings
- spells: Wert für spells konnte nicht ermittelt werden: "Corpofrigo 7 (10/14/12)"

### Resolver Warnings
- specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- specialAbilities: Eintrag "Tradition (Nachtalben)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- spells: Eintrag "Corpofrigo 7 (10/14/12)" konnte im Abschnitt spells nicht aufgelöst werden.
- spells: Eintrag "Schlachtlied" konnte im Abschnitt spells nicht aufgelöst werden.

### Unresolved References
- **specialAbilities**: Beidhändiger Kampf I-II, Tradition (Nachtalben)
- **spells**: Corpofrigo 7 (10/14/12), Schlachtlied

### Exporter Warnings
- [Parser] spells: Wert für spells konnte nicht ermittelt werden: "Corpofrigo 7 (10/14/12)"
- [Resolver] specialAbilities: Eintrag "Beidhändiger Kampf I-II" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Tradition (Nachtalben)" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Corpofrigo 7 (10/14/12)" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] spells: Eintrag "Schlachtlied" konnte im Abschnitt spells nicht aufgelöst werden.
- [Resolver] specialAbilities: unverarbeitet "Beidhändiger Kampf I-II"
- [Resolver] specialAbilities: unverarbeitet "Tradition (Nachtalben)"
- [Resolver] spells: unverarbeitet "Corpofrigo 7 (10/14/12)"
- [Resolver] spells: unverarbeitet "Schlachtlied"
...
### Unresolved References
- **specialAbilities**: Finte I-II, Kampfreflexe I-III
- **weapons**: Mandibeln
...
### Resolver Warnings
- specialAbilities: Eintrag "Wuchtschlag I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- weapons: Eintrag "Scheren" konnte im Abschnitt weapons nicht aufgelöst werden.
- weapons: Waffe "Shakagra-Kriegshammer" wurde als "Kriegshammer" interpretiert (Teilbegriff "Kriegshammer").

### Unresolved References
- **specialAbilities**: Wuchtschlag I-III
- **weapons**: Scheren

### Exporter Warnings
- [Resolver] specialAbilities: Eintrag "Wuchtschlag I-III" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] weapons: Eintrag "Scheren" konnte im Abschnitt weapons nicht aufgelöst werden.
- [Resolver] weapons: Waffe "Shakagra-Kriegshammer" wurde als "Kriegshammer" interpretiert (Teilbegriff "Kriegshammer").
- [Resolver] specialAbilities: unverarbeitet "Wuchtschlag I-III"
- [Resolver] weapons: unverarbeitet "Scheren"
...
### Resolver Warnings
- advantages: Eintrag "Dunkesicht I" konnte im Abschnitt advantages nicht aufgelöst werden.
- disadvantages: Eintrag "Dunkesicht I" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- specialAbilities: Eintrag "Flugangriff" konnte im Abschnitt specialAbilities nicht aufgelöst werden.

### Unresolved References
- **advantages**: Dunkesicht I
- **disadvantages**: Dunkesicht I
- **specialAbilities**: Flugangriff

### Exporter Warnings
- [Resolver] advantages: Eintrag "Dunkesicht I" konnte im Abschnitt advantages nicht aufgelöst werden.
- [Resolver] disadvantages: Eintrag "Dunkesicht I" konnte im Abschnitt disadvantages nicht aufgelöst werden.
- [Resolver] specialAbilities: Eintrag "Flugangriff" konnte im Abschnitt specialAbilities nicht aufgelöst werden.
- [Resolver] advantages: unverarbeitet "Dunkesicht I"
- [Resolver] disadvantages: unverarbeitet "Dunkesicht I"
