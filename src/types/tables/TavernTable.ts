...
const TAVERN_CONFIG: TableConfigMap = {
  ...
  properNamePlural: {
    ...
    die: 20,
    entries: [
      { range: "1", result: "Einhörner" },
      { range: "2", result: "Stiere" },
      { range: "3", result: "Hirsche" },
      { range: "4", result: "Könige" },
      { range: "5", result: "Prinzessinnen" },
      { range: "6", result: "Keiler" },
      { range: "7", result: "Adler" },
      { range: "8", result: "Kronen" },
      { range: "9", result: "Henker" },
      { range: "10", result: "Reisenden" },
      { range: "11", result: "Quallen" },
      { range: "12", result: "Delphine" },
      { range: "13", result: "Karpfen" },
      { range: "14", result: "Ponys" },
      { range: "15", result: "Stiefel" },
      { range: "16", result: "Vagabunden" },
      { range: "17", result: "Stuten" },
      { range: "18", result: "Eimer" },
      { range: "19", result: "Pilger" },
      { range: "20", result: "Trommeln" },
    ],
  },
  properNameSpecial1: {
    description: null,
